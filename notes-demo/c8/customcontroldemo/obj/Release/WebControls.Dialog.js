...
function ResizeStart(event,resizeObjectID,resizeDraggerID)
{		
	...
	if(resizeDraggerID == null) {
		resizer.dragger = event.srcElement;
	} else {
		resizer.dragger = document.getElementById(resizeDraggerID);
	}	
...
{							
	var w,h;
	w = resizer.width + parseInt(resizer.dragger.style.left);
	h = resizer.height + parseInt(resizer.dragger.style.top);
...
function resizeSTOP()
{
	...
	var rsz = document.getElementById("rszBtn");
